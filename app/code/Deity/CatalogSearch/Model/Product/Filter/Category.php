...
namespace Deity\CatalogSearch\Model\Product\Filter;
 ...
 * Class Category
 *
 * @package Deity\CatalogSearch\Model\Product\Filter
 */
class Category implements FilterDataRendererInterface
{
    ...
    public function getFilterData(
        ...
        if (!empty($selectedValues)) {
            $currentCategory = $this->categoryRepository->get(array_pop($selectedValues));
            $filterOption =$this->filterOptionFactory->create(
                [
